...
$productCards = array_filter([
  ...
  'products/recodik' => [
    'label' => 'Free, self-hosted record keeper',
    'name'  => 'Recodik',
    'href'  => '/products/recodik.php',
    'desc'  => 'A no-code record keeper you fully customize &mdash; build your own categories and fields for customers, passwords, domains, anything. Free, no license, self-hosted.',
    'stats' => [['Free', 'No license, ever'], ['14', 'Field types to build with']],
  ],
